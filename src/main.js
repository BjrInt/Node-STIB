...
var Stib = /** @class */ (function () {
    ...
    Stib.prototype.getLineDescription = function (lines) {
        return (0, helpers_1.groupedQueries)(lines, this.token, 'NETWORK_DESCRIPTION', 'LINES', function (data) { return data.map(function (d) { return d.lines; }).flat(); });
    };
    Stib.prototype.getStopDescription = function (stops) {
        return (0, helpers_1.groupedQueries)(stops, this.token, 'NETWORK_DESCRIPTION', 'STOPS', function (data) { return data.map(function (d) { return d.points; }).flat(); });
    };
    Stib.prototype.getVehiclePosition = function (lines) {
