...
exports.groupedQueries = exports.tokenQuery = exports.httpQuery = exports.splitInSubgroupOf = exports.base64Encode = void 0;
...
var splitInSubgroupOf = function (a, size) {
    ...
    for (var i = 0; i < subgroups; i++) {
        returnValue.push(__spreadArray([], a.slice(i * size, (i + 1) * size), true));
    }
    return returnValue;
};
...
var groupedQueries = function (arg, token, endpoint, resource, responseCallback) {
    return new Promise(function (resolve, reject) {
        ...
        if (arg.length > constants_1.LIMIT_QUERY_PARAM[endpoint][resource] * constants_1.RATE_LIMITS[endpoint])
            return reject({ error: 'RATE_LIMIT_EXCEEDED' });
        var queries = (0, exports.splitInSubgroupOf)(arg, constants_1.LIMIT_QUERY_PARAM[endpoint][resource])
